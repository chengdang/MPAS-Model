...
!    Dang, C., Zender, C. S., and Flanner, M. G.:
!    Inter-comparison and improvement of 2-stream shortwave radiative transfer
!    models for unified treatment of cryospheric surfaces in ESMs,
!    The Cryosphere Discuss., https://doi.org/10.5194/tc-2019-22, in review, 2019.
...
!-----------------------------------------------------------------------
      ...
      ! config_use_SNICAR_AD new local variables
      integer (kind=int_kind), parameter :: &
         nmbrad_snicar  = 1471    , &! number of snow grain radii in SNICAR
                                     ! snow iops table
         rsnw_snicar_max = 1500   , & ! maximum snow grain size
         rsnw_snicar_min = 30         ! minimum snow grain size
      ...
      ! note by Cheng Dang: update 5-band sea ice iops when they are avalible
